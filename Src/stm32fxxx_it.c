...
void ADC_IRQHandler(void)
{
  /* USER CODE BEGIN ADC_IRQn 0 */
	if ( LL_ADC_IsActiveFlag_JEOS(ADC1) && LL_ADC_IsEnabledIT_JEOS(ADC1) )
	{
    ...
    then xHigherPriorityTaskWoken will automatically get set to pdTRUE. */
		...
		/*
			frequecy: 1000Hz, this interrupt is triggered by TIM1,
			then notify FreeRTOS task to perform motor control.
		*/
		vTaskNotifyGiveFromISR(xAPI_TaskHandle, &xHigherPriorityTaskWoken);
